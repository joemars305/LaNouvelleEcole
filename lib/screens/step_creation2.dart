...
/// TODO
/// 
/// - crée un bouton full screen / normal screen,
/// qui met la photo en mode full screen, 
/// ou taille naturelle (OK !)
/// 
/// - crée un bouton texte qui permet d'ajouter du texte
/// 
/// - crée un bouton poubelle qui supprime 
/// le dernier texte ou emoji
/// 
/// - crée un bouton microphone
/// pour démarrer un enregistrement audio
...
class _StepCreationState extends State<StepCreation> {
  ...
  /// null pour NO_TEXT
  /// String pour TEXT
  String _currentText = NO_TEXT;

  /// template
  /*void fnFor...(String currentText) {
    if (currentText == NO_TEXT) {
      return ...;
    } else {
  ...
  /// l'icone nous permettant de rajouter du texte
  Widget textIcon() {
    return IconButton(
      icon: Icon(
        Icons.text_fields,
      ...
      onPressed: () async {
        ...
        // if the input is valid and
        // has 1 or more letters,
        // create a dragbox containing this user input,
        // and add it to the list of dragbox to 
        // be displayed on the photocanvas
        /*if (inputIsValid(input)) {

        }
        /// otherwise display a snackbar telling the user that the text is invalid
        else {
          displayMsg();
        }*/
      },
  ...
  Widget photoSizeIcon(int photoSize) {
    IconData icon;
    Function fn;
  ...
  // l'ensemble de l'écran de création d'étapes
  @override
  Widget build(BuildContext context) {
